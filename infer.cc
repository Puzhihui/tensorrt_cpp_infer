...
// char* trt_model_path = (char*)"../models/effnetv2_int8.trt";
char* trt_model_path = (char*)"/mnt/data1/leif/project/ADC/TensorRT/Generate_LibMyTtrEngine-trt721/src/model_7.plan";
// std::string test_img = "../test_imgs/dog.32.jpg";
std::string test_img = "/mnt/data1/leif/data/jssi/test/AAIDBRG0003IN/Bad/Contamination/D00011864-R94-C114-79531110--48003520#540-540-8139.jpg";
...
int main(int argc, const char *argv[]) {
    ...
    strcpy(cur_in_tensor_params[0].aTensorName, "input");
